...
def shiftedColorMap(cmap, start=0, midpoint=0.5, stop=1.0, name='shiftedcmap',nomid=False):
    '''
    ...
    -----
      ...
      nomid: if the midpoint of the original colormap should not be included
    '''
    cdict = {
        'red': [],
        'green': [],
