...
from generate_nonuniform_grid import generate_nonuniform_grid_bezier,generate_nonuniform_grid_Int_arctan
...
grid_params={"nonuniform":True, "grid_type":"Int_arctan","transition_length":0.025, "pedestal_grid_density":0.9,"leftshift":10*0.025,"rightshift":10*0.025}

grid_profile_params=  dict(profile_params.items() + grid_params.items())


generate_compatible_profiles(simul,mI=mI,zI=zI,eI=eI,imp_conc=imp_conc,xwidth=xwidth,a=a,dxdpsiN=dxdpsiN,upShift_denom=upShift_denom,sameflux=True,mode="const_Phi",**grid_profile_params)
