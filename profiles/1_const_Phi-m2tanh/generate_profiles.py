...
generate_compatible_profiles(simul,mI=mI,zI=zI,eI=eI,imp_conc=c,xwidth=xwidth,a=a,dxdpsiN=dxdpsiN,upShift_denom=upShift_denom,sameflux=False,m2tanh=True,**profile_params)
