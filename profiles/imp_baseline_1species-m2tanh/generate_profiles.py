...
generate_compatible_profiles(simul,mI=mI,imp_conc=imp_conc,xwidth=xwidth,a=a,dxdpsiN=dxdpsiN,upShift_denom=upShift_denom,sameflux=True,m2tanh=True,mode="const_Phi",**profile_params)
