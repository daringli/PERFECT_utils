...
from generate_compatible_profiles import generate_compatible_profiles_constant_ne
from generate_nonuniform_grid import generate_nonuniform_grid_bezier
...
profile_params={"Tped_"+species[eI]:Tped_e,"dTCoredx_"+species[eI]:dTCoredx_e,"dTpeddx_"+species[eI]:dTpeddx_e,"dTSOLdx_"+species[eI]:dTSOLdx_e,"TScale_"+species[eI]:TScale_e,
                ...
                "Tped_"+species[zI]:Tped_i,"dTCoredx_"+species[zI]:dTCoredx_i,"dTpeddx_"+species[zI]:dTpeddx_i,"dTSOLdx_"+species[zI]:dTSOLdx_i,"TScale_"+species[zI]:TScale_i,
                "nped_"+species[eI]:nped_i,"dnCoredx_"+species[eI]:dnCoredx_i,"dnpeddx_"+species[eI]:dnpeddx_i,"dnSOLdx_"+species[eI]:dnSOLdx_i,"nScale_"+species[eI]:nScale_i,
...
grid_params={"nonuniform":True, "grid_type":"Int_arctan","transition_length":0.025, "pedestal_grid_density":0.5}

grid_profile_params=  dict(profile_params.items() + grid_params.items())


generate_compatible_profiles_constant_ne(simul,mI=mI,eI=eI,zI=zI,xwidth=xwidth,a=a,dxdpsiN=dxdpsiN,upShift_denom=upShift_denom,imp_conc=c,sameflux=False,m2tanh=True,**grid_profile_params)
