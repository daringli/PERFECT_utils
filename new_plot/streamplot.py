...
def streamplot(axes, x, y, u, v, density=1, linewidth=None, color=None,
               cmap=None, norm=None, arrowsize=0.5, arrowstyle='->',
               minlength=0.1, transform=None,vmin=None,vmax=None,linecolor=None,rasterized=False):
    ...
    *minlength* : float
    ...
    if rasterized is True:
        line_kw['rasterized'] = True
        #arrow_kw['rasterized'] = True #currently not implemented in matplotlib
